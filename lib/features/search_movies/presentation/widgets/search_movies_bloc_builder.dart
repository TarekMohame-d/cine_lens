...
import 'package:cine_lens/features/movies/presentation/widgets/see_all/movies_see_all_list_view_item.dart';
    ...
    return Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          return MoviesSeeAllListViewItem(movie: searchMovies[index]);
        },
      ),
    );
  }
